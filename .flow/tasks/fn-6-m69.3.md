...
- [ ] ruff clean
## Done summary
Rewrote build_system_prompt() with comprehensive CRUD decision rules (CREATE/UPDATE/DELETE), asymmetric confidence guidance, 3 few-shot examples, 2 negative examples, calendar_context parameter with lost-in-the-middle placement, and last-statement-wins instruction. Expanded tests from 8 to 20.
## Evidence
- Commits: cbfe992f7f4f2ff3bf464e35694e74683a6fb693
- Tests: python3 -m pytest tests/unit/test_prompts.py -v (20 passed), python3 -m pytest --tb=short -q (283 passed, 0 regressions), python3 -m ruff check . (all passed)
- PRs: